...
Grup adalah tempat komunitas berada dalam Protokol — mereka adalah kumpulan kontak yang Anda ajak bicara sekaligus. Di halaman ini, kita akan mendalami berbagai titik akhir grup yang dapat Anda gunakan untuk mengelola grup secara terprogram. Kita akan melihat cara membuat kueri, membuat, memperbarui, dan menghapus grup. {{ className: 'lead' }}
